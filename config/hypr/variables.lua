...
return {
    ...
    kbPinWindow                = "SUPER + P",
    kbWindowFullscreen         = "ALT + Q",
    kbWindowBorderedFullscreen = "ALT + D",
    kbToggleWindowFloating     = "ALT + F",
    kbCloseWindow              = "SUPER + Q",

    -- Special workspaces toggles
    kbSpecialWs                = "SUPER + S",
    kbSystemMonitorWs          = "ALT + W",
    kbMusicWs                  = "ALT + X",
    kbTermWs                   = "ALT + C",
    kbCommunicationWs                   = "ALT + V",
    ...
    -- Wallpaper picker
    kbWallpaperToggle          = "MOD5 + L",
    kbWallpaperLeft            = "MOD5 + K",
    kbWallpaperRight           = "MOD5 + M",
}
