...
local terminal_ws_tag = "terminal_ws"
...
tagged_rule(music_player_tag, {
    "Spotify" -- Spotify wayland, it has no class for some reason
}, "class")
...
tagged_rule(terminal_ws_tag, {
    "kitty-term" -- Kitty instances for the terminal special workspace
}, "class")
...
create_tag(terminal_ws_tag, { workspace = "special:term" })
