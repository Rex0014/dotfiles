...
create_bind(vars.kbTermWs, fn.toggle("term"))
...
create_bind(vars.kbdropdownterminal, hl.dsp.exec_cmd("caelestia toogle term"))
...
-- Media
create_bind({ vars.kbMediaToggle, "XF86AudioPlay", "XF86AudioPause", "XF86AudioMute" }, hl.dsp.global("caelestia:mediaToggle"), locked)
...
-- Wallpaper picker
create_bind(vars.kbWallpaperToggle, hl.dsp.exec_cmd("qs ipc -p /home/rex/.config/quickshell/wallpaper call wallpaper toggle"))
create_bind(vars.kbWallpaperLeft, hl.dsp.exec_cmd("qs ipc -p /home/rex/.config/quickshell/wallpaper call wallpaper left"))
create_bind(vars.kbWallpaperRight, hl.dsp.exec_cmd("qs ipc -p /home/rex/.config/quickshell/wallpaper call wallpaper right"))
